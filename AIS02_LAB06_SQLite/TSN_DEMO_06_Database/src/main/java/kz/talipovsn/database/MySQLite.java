...
public class MySQLite extends SQLiteOpenHelper {
    ...
    static final String DATABASE_NAME = "IDE"; // Имя базы данных

    static final String TABLE_NAME = "top_ides"; // Имя таблицы
    ...
    static final String ASSETS_FILE_NAME = "top_ides.txt"; // Имя файла из ресурсов с данными для БД
    ...
    public void addData(SQLiteDatabase db, String name, String site,
                        String platform, String lang, String payment) {
