...
public class ActivityPaySoftware extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pay_software);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.email) {
            ...
            try {
                ...
                Toast.makeText(ActivityPaySoftware.this, R.string.Нет_установленного_почтового_клиента, Toast.LENGTH_SHORT).show();
            }
            return true;
        }
    ...
    public void onBackPayIde(View view) {
        // Создание второго окна
        Intent intent = new Intent(ActivityPaySoftware.this, StartActivity.class);
