...
public class MySQLite extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 10; // НОМЕР ВЕРСИИ БАЗЫ ДАННЫХ И ТАБЛИЦ !
    ...
    static final String ASSETS_FILE_NAME = "pay_ide.txt"; // Имя файла из ресурсов с данными для БД
