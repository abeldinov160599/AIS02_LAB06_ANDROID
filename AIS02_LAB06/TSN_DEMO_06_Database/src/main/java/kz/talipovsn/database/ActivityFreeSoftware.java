...
public class ActivityFreeSoftware extends AppCompatActivity {
    ...
    SQLiteFreeIdes db = new SQLiteFreeIdes(this); // Класс работы с нашей базой данных
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner = findViewById(R.id.spinner_free);

        // Активация меню
        Toolbar toolbar = findViewById(R.id.toolbar_free);
        setSupportActionBar(toolbar);

        // Доступ к компонентам
        editText = findViewById(R.id.editText_free);
        textView = findViewById(R.id.textView_free);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.email) {
            ...
            try {
                ...
                Toast.makeText(ActivityFreeSoftware.this, R.string.Нет_установленного_почтового_клиента, Toast.LENGTH_SHORT).show();
            }
            return true;
        }
    ...
    public void onBackFreeIde(View view) {
        // Создание второго окна
        Intent intent = new Intent(ActivityFreeSoftware.this, StartActivity.class);
